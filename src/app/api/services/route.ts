...
let services = [
  {
    ...
    location: "Maldives",
    amenities: ["Spa", "Restaurant", "Pool", "WiFi", "Beach Access"],
    availability: true,
  ...
  },
  {
    ...
    location: "Nepal",
    amenities: ["Guide", "Equipment", "Meals", "Camping Gear"],
    availability: true,
  ...
  },
  {
    ...
    location: "Europe",
    amenities: ["Guide", "Hotels", "Meals", "Transportation"],
    availability: true,
  ...
  },
  {
    ...
    location: "Global",
    amenities: ["Professional Driver", "Luxury Vehicle", "24/7 Service", "Meet & Greet"],
    availability: true,
  ...
  },
  {
    ...
    location: "New York",
    amenities: ["Rooftop Bar", "Gym", "WiFi", "Concierge", "Restaurant"],
    availability: true,
  ...
  },
  {
    ...
    location: "Caribbean",
    amenities: ["Certified Instructor", "Equipment", "Boat Transfer", "Lunch"],
    availability: true,
  ...
  },
  {
    ...
    location: "Italy",
    amenities: ["Wine Tasting", "Lunch", "Transportation", "Guide"],
    availability: true,
  ...
  },
  {
    ...
    amenities: ["Professional Pilot", "Safety Equipment", "Photo Opportunities", "Commentary"],
    availability: true,
  ...
  try {
    ...
    if (search) {
      ...
      filteredServices = filteredServices.filter(service =>
        ...
        service.vendor.name.toLowerCase().includes(searchLower) ||
    ...
    return NextResponse.json({ 
      ...
      categories: ['accommodation', 'tours', 'transport', 'adventure']
    });
  } catch (error: any) {
    return NextResponse.json(
...
export async function POST(request: Request) {
  try {
    ...
    const requiredFields = ['title', 'description', 'price', 'category', 'vendorId'];
